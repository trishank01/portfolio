    ...
    <section>
      <div
        className={`flex flex-col md:flex-row  duration-300  xl:w-[1240px] absolute ${
          width < 640 ? "left-[55px]" : "left-[240px]"
        }  h-screen w-[80%]`}
      >
        ...
        <div className="relative ml-[50px] mt-[50px] w-[75%] md:w-[50%] flex justify-center items-center">
          {CardData.map((card) => {
            return (
              <div
                class={`absolute top-0 md:top-16 ${
                  zindex === card.id || current === card.id
                    ? "z-10 scale-110 translate-x-14"
                    : ""
                } max-w-sm  rounded overflow-hidden duration-300  bg-color-base shadow-lg`}
              >
                <img
                ...
                <div class="px-6 py-4">
                  ...
                  <p class="text-white-700 text-base">{card.details}</p>
                </div>
